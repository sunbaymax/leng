<?php
if (isset($_GET['code'])){
			$url="https://api.weixin.qq.com/sns/oauth2/access_token?appid=wxe9b057d10330ccf4&secret=1a39da83c7b266004f773612fbd36fe6&code=".$_GET['code']."&grant_type=authorization_code";
