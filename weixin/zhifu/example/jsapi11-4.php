						...
						$.ajax({
							...
							success: function(data) {
								...
								if(_json.code == 10000 && _json.message == "success" && _json.resultCode == "success") {
									var _openId=["oSPfHv6VlfxV4bRPRatRl1BtNl8Q","oSPfHv-pXx-_E5jFehQHWQy1lpmI","oSPfHv17xGpC6zVfDQ-bErQf-cko","oSPfHv84aKIanXMRwVie1dGybNxQ","oSPfHv1vTpBnh_tiJ4X6-2lFnmEE","oSPfHv8Ir9Nwt9xArDUbwPr5Pt2Q",'oSPfHv7L87tsrNKPr9MWI_XvOuf8'];
   								    //var _openId=["oSPfHv-pXx-_E5jFehQHWQy1lpmI"];
...
//												}
											...
											error:function(){
												console.log("如未付款成功请联系'智冷科技客服人员'");
												return false;
											}
										});
									}
									...
									console.log("网络错误，请立即联系'智冷科技'客服人员确认是否已收到付款！");
									return false;
								}
							},
							error:function(){
