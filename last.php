        ...
        switch ($object->Event) {
            case "subscribe":
				if(!empty($object->EventKey)){
					$content = '北京中集智冷科技有限公司是中集集团旗下，一家集物联网产品研发、生产、销售为一体的创新型企业，主营产品包括40余种传感器、远程监测、智能控制设备以及云平台服务。为冷链、种养殖等行业提供一体化产品服务及综合解决方案，提供项目定制级技术支持。欢迎您成为注册中集智冷科技有限公司合作经销商。 ';
					$baseKey = str_replace('qrscene_', '', $object->EventKey);
					$content .= "\n\n".'<a href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx029d1989acb9f44c&redirect_uri=http://www.ccsc58.cc/leng/DealerH5/oauth2.php&response_type=code&scope=snsapi_userinfo&state='.$baseKey.'#wechat_redirect">中集智冷经销商注册入口</a>';
				}else{
					$content = "感谢关注“中集智冷科技”微信公众号。北京中集智冷科技致力于医药、食品、农牧业等多个行业的冷链全过程温控物联网软硬件产品的开发与应用，并提供OEM定制、仪表校准、冷链验证、行业解决方案等增值服务。\n
温控平台使用：
1、鲜盾产品用户请直接点击左下角“温控平台” 小程序版，注册您的手机号后登录、绑定设备 
2、PC端（电脑）登录网址：<a href=\"https://t.ccsc58.com/#/Login\">https://t.ccsc58.com</a>\n
左下角打开键盘，输入您问题的关键词获取自动回复，快来试试吧！";
				}
                ...
                $sql = "INSERT INTO tb_weixin_user (openid,unionid,nickname,sex,country,province,city,headimgurl,subscribe,subscribe_time) values('$openid','$unionid','$nickname','$sex','$country','$province','$city','$headimgurl','$subscribe','$subscribe_time')";
                ...
                switch ($object->EventKey) {
                    ...
                    case "lianxiwomen":
                        $content = array(array("Title" => "联系我们",
                            "Description" => "售前电话：400-618-0990，转1号按键\n售后电话：400-618-0990，转2号按键\n公司官网：www.ccsc58.com",
                            "PicUrl" => "http://qiniu.ccsc58.com/FgIMKZfHhcKskP_VxDdirK1tNlC3",
                            "Url" => "http://www.ccsc58.com"));
                        break;
                    case "tel":
                        $content = "售前电话：400-618-0990，转1号按键\n售后电话：400-618-0990，转2号按键";//点击公众下面的菜单想用户推送的内容匹配；
                        break;
            ...
            case "SCAN":
				...
				$content = '北京中集智冷科技有限公司是中集集团旗下，一家集物联网产品研发、生产、销售为一体的创新型企业，主营产品包括40余种传感器、远程监测、智能控制设备以及云平台服务。为冷链、种养殖等行业提供一体化产品服务及综合解决方案，提供项目定制级技术支持。欢迎您成为注册中集智冷科技有限公司合作经销商。 ';
                $content .= "\n\n<a href=\"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx029d1989acb9f44c&redirect_uri=http://www.ccsc58.cc/leng/DealerH5/oauth2.php&response_type=code&scope=snsapi_userinfo&state=".$object->EventKey."#wechat_redirect\">中集智冷经销商注册入口</a>";
                break;
            case "LOCATION":
...
//              break;
    ...
    private function receiveText($object)
    {
        ...
        } else if ($keyword == "换卡" || $keyword == "到期" || $keyword == "停机") {
            $content = "<a href=\"https://mp.weixin.qq.com/s/OTYjXTbMayvlozFCPmxS5Q\">设备快到期？已过期需要换卡？查看完整攻略</a>";
        } else if ($keyword == "教程" || $keyword == "使用教程") {
            $content = "<a href=\"http://mp.weixin.qq.com/s/Tf87L9zLq4U0EhuMTSqkEg\">使用教程</a>";
        } else if (strstr($keyword, "1000b") || strstr($keyword, "1000B")) {
...
//	        $content = "<a href=\"https://mp.weixin.qq.com/s/jeE2TKAsRx0PcygTmq3xkw\">使用教程</a>";
            $content = array();
            $content[] = array("Title" => "使用教程", "Description" => "邀请家人教程指导", "PicUrl" => "https://mmbiz.qpic.cn/mmbiz_png/Mq386YqibNyvtDiahpMkCCGibicI1oN1focicXYcoLMeXwMJO3hDyd0MIaZb16FZ8ImSZnbBsPA1cGuY5pKkvl54I4g/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1", "Url" => "https://mp.weixin.qq.com/s/jeE2TKAsRx0PcygTmq3xkw");
...
//	        $content = "<a href=\"https://mp.weixin.qq.com/s/UnfecYe3df0z-pGq1BcWXg\">使用教程</a>";
        ...
        } else if ($keyword == "申请发票" || strstr($keyword, "发票")) {
            $content = "<a href=\"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx029d1989acb9f44c&redirect_uri=http://www.ccsc58.cc/leng/mobileinvoice/oauth2.php&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect\">发票申请</a>";
            ...
            //$content = "<a href=\"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx029d1989acb9f44c&redirect_uri=http://www.ccsc58.cc/leng/oauth2.php&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect\">授权</a>";
            $content = "<a href=\"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx029d1989acb9f44c&redirect_uri=http://www.ccsc58.cc/leng/RepairOrder/oauth2.php&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect\">填写售后工单</a>";
...
//      }
            ...
            $content = "<a href=\"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx029d1989acb9f44c&redirect_uri=http://www.ccsc58.cc/leng/oauth2_messbangding.php&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect\">微信绑定</a>";
            ...
            $content = array("PicUrl" => "http://www.ccsc58.com", "MediaId" => "5xyWfHmqrh80d1zZyXjzj51foEma_XoLpDkrZJD3p-gFZJR5uP0oAv7E6duW6zt8");
            ...
            //$content = date("Y-m-d H:i:s",time())."\nOpenID：".$object->FromUserName."\n技术支持 方倍工作室";
            $content = "您好！您可以回复以下内容：\n\n☞【产品资料】:<a href=\"http://www.ccsc58.cc/weixinnew/menuSwiper/product.html\">产品资料</a>\n\n☞【配置】:<a href=\"http://www.ccsc58.cc/leng/softwareconfig/index.html\">配置软件</a>\n\n☞【官网】:<a href=\"http://www.ccsc58.com\">公司官网</a>\n\n ☞【邀请家人】:<a href=\"https://mp.weixin.qq.com/s/jeE2TKAsRx0PcygTmq3xkw\">邀请家人</a>\n\n☞【投诉/建议】:<a href=\"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx029d1989acb9f44c&redirect_uri=http://www.ccsc58.cc/leng/ComplaintSuggest/oauth2.php&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect\">投诉/建议</a>\n\n ☎ 售前电话：400-618-0990，转1号按键\n ☎ 售后电话：400-618-0990，转2号按键";
            $picContent = array("PicUrl" => "http://www.ccsc58.com", "MediaId" => "5xyWfHmqrh80d1zZyXjzj51foEma_XoLpDkrZJD3p-gFZJR5uP0oAv7E6duW6zt8");
        }
        ...
        if (!empty($result)) {
            ...
            $result = $this->transmitText($object, $content);
            $this->transmitImage($object, $picContent);
        }
//      sleep(3);
//      if(isset($picContent['PicUrl'])){
//  		$result = $this->transmitImage($object, $picContent);
//  	}
        return $result;
    }
