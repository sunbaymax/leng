						...
						<div class="list hidden">
							...
							<div class="daoqi" id="daoqi">
								...
								<div class="daoqicontent">
									您的设备服务已到期，请于<span class="daoqiTime"></span>前进行缴费，逾期该设备SIM卡将被注销。
								</div>
								<div>
									<button>前往缴费</button>
								</div>
							...
							if(res.code == 0 && res.message == 'success') {
							   if(res.data.count<=5){
								...
								for(var i = 0; i < res.data.data.length; i++) {
									...
									_dem.find("#caozuo .Untyingbtn").addClass('hidden');
...
//					console.log(copenid,33)
					$.ajax({
						url: "http://erpapi.ccsc58.com/xiandun/public/index.php/index/device/xiandu_device_list",
						type: "post",
						data: {
							openid: copenid,
							offset: _start,
