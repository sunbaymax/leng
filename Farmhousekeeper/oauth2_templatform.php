...
if (isset($_GET['code'])){
			$url="https://api.weixin.qq.com/sns/oauth2/access_token?appid=wxf9b1fec99bb02c4a&secret=1d0c444f30ec42ca8ff5279a1bd3abf2&code=".$_GET['code']."&grant_type=authorization_code";
